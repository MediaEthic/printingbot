...
<div class="mx-auto h-full flex justify-center items-center bg-gray-300">
    <div class="w-96 bg-blue-900 rounded-lg shadow-xl p-6">
        ...
        <svg class="fill-current text-white w-16" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<g>
    <g>
        ...
        <h1 class="text-white text-3xl pt-8">Bon retour parmi nous sur Printingbot</h1>
        <h2 class="text-blue-300">Saisissez vos identifiants</h2>
